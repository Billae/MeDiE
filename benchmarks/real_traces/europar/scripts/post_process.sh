...
cd $path
split -l 500 percentages.csv percent
cd -
...
gnuplot -c scripts/display_percentage_load.gnu $path $run aa
gnuplot -c scripts/display_percentage_load.gnu $path $run ab
gnuplot -c scripts/display_percentage_load.gnu $path $run ac
