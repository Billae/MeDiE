...
#average speed
plot 'means_2_srv' using 1:($1*10000/$2) w lp 
replot 'means_4_srv' using 1:($1*10000/$2) w lp
replot 'means_8_srv' using 1:($1*10000/$2) w lp
replot 'means_16_srv' using 1:($1*10000/$2) w lp
